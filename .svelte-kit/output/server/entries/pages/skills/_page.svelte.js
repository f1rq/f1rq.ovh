...
import { z as push, I as fallback, J as attr_class, K as clsx, M as slot, N as invalid_default_snippet, O as bind_props, C as pop, P as attr } from "../../../chunks/index.js";
...
function SkillsMagicCard($$payload, $$props) {
  ...
  $$payload.out += `<div${attr_class(clsx(cn("group relative flex size-full overflow-hidden rounded-xl bg-neutral-100 dark:bg-base-100 border text-black dark:text-white justify-center py-4", className)), "svelte-1dd4shl")}><div class="relative z-10 w-[90px]"><!---->`;
...
function Skills($$payload) {
  ...
  BlurFade($$payload, {
    delay: 0.1 * 2,
    children: ($$payload2) => {
      $$payload2.out += `<div class="gapphone grid grid-cols-4 gap-4 container svelte-1jyhixj"><a href="https://svelte.dev" target="_blank">`;
      ...
      $$payload2.out += `<!----></a> <a href="https://www.arduino.cc/" target="_blank">`;
      SkillsMagicCard($$payload2, {
        ...
        gradientSize: 100,
        children: ($$payload3) => {
          $$payload3.out += `<div class="transition-all duration-500 flex gap-1.5 justify-center items-center"><img${attr("src", ArduinoLogo)} alt="arduino_logo" class="size-12"></div>`;
        },
        $$slots: { default: true }
      });
      $$payload2.out += `<!----></a></div>`;
