...
import { z as push, I as fallback, J as attr_class, K as clsx, M as slot, N as invalid_default_snippet, O as bind_props, C as pop } from "../../../chunks/index.js";
...
function MagicCard($$payload, $$props) {
  ...
  $$payload.out += `<div${attr_class(clsx(cn("group relative flex size-full overflow-hidden rounded-xl bg-neutral-100 dark:bg-base-100 border text-black dark:text-white justify-center py-4", className)), "svelte-1dd4shl")}><div class="relative z-10"><!---->`;
